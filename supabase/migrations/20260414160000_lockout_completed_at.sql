...
ALTER TABLE lockout_sessions ADD COLUMN IF NOT EXISTS completed_at TIMESTAMPTZ DEFAULT NULL;

-- ============================================================================
-- 12. Partial index for active-lockout queries (created early so all
--     subsequent functions benefit from it immediately)
-- ============================================================================
CREATE INDEX IF NOT EXISTS idx_lockout_sessions_completed_at
