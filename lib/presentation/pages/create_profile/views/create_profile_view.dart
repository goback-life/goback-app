...
import 'package:cloudless/core/features/profile/domain/hooks/use_create_profile_form.dart';
...
class CreateProfileView extends HookConsumerWidget
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final formResult = useCreateProfileForm(ref);
              ...
              Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Text(
                      translator.translate('pages.create_profile.edit_image'),
