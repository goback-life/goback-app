...
class TutorialLockoutPhase extends HookWidget {
  ...
  Widget build(BuildContext context) {
    final subStep = useState(0); // 0 = explanation, 1 = friend adding
    ...
    // Exit conditions (only during friend-adding step)
    useEffect(() {
      if (subStep.value != 1) return null;
    ...
    return GestureDetector(
      ...
      child: Stack(
        ...
        children: [
          ...
          // Layer 3: Friend adder OR explanation tooltip
          if (subStep.value == 0)
            TutorialTooltip(
              message:
