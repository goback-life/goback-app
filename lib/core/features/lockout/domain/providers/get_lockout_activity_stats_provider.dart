...
part 'get_lockout_activity_stats_provider.g.dart';

@riverpod
Future<Result<List<LockoutActivityStatsDto>>> getLockoutActivityStats(
  Ref ref, {
  ...
  return service.getActivityStats(userId: userId);
}
