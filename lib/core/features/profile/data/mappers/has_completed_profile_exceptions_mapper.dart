...
class HasCompletedProfileExceptionsMapper {
  static MainException fromSupabaseException(Exception e) {
      ...
      switch (e.code) {
        ...
        case 'PGRST100':
          return UnhandledException(
            'Invalid profile completion check parameters: ${e.message}',
            code: e.code,
            cause: e,
          );
        ...
        default:
          return UnhandledException(
            'Profile completion check failed: ${e.message}',
            code: e.code,
            cause: e,
          );
      }
    ...
    if (e is FormatException) {
      return UnhandledException(
        'Invalid profile completion data format received',
        cause: e,
      );
    }
    ...
    if (e is TypeError) {
      return UnhandledException(
        'Profile completion data type mismatch',
        cause: e,
      );
    }
    ...
    if (e is ArgumentError) {
      return UnhandledException(
        'Invalid user ID provided for profile completion check',
        cause: e,
      );
    }
    ...
    return UnhandledException(
      'Profile completion check error occurred',
      cause: e,
    );
  }
}
