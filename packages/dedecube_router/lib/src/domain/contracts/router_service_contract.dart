...
/// A contract defining the required router service for an application.
...
abstract class RouterServiceContract {
  ...
  /// Navigates to the given [route] by moving to it without pushing a new route.
  ///
  ...
  ///
  /// - [route]: The [BaseRoutable] route that will replace the current route.
  /// - [context]: The build context (optional). If not provided, the navigator key's
  ///   current context will be used.
  ///
  ...
  ///
  /// This method checks if the navigation stack contains at least one route that can be removed.
  ///
  /// - [context]: The build context (optional). If not provided, the navigator key's
  ///   current context will be used.
  ///
